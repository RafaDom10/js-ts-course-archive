...
var qtdCaracteres = document.querySelector('.quantidade-caracteres');
...
var btnGerar = document.querySelector('.gerar-senha');
...
function gera() {
  var senha = (0,_gerador__WEBPACK_IMPORTED_MODULE_0__.default)(qtdCaracteres.value, chkMaiusculas.checked, chkMinusculas.checked, chkNumeros.checked, chkSimbolos.checked);
