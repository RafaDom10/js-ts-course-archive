...
var GeraCPF = /*#__PURE__*/function () {
  ...
  _createClass(GeraCPF, [{
    ...
    value: function geraNovoCPF() {
      ...
      var digito1 = _ValidateCPF__WEBPACK_IMPORTED_MODULE_0__.default.generateDigit(cpfSemDigito);
      var digito2 = _ValidateCPF__WEBPACK_IMPORTED_MODULE_0__.default.generateDigit(cpfSemDigito + digito1);
...
var ValidateCPF = /*#__PURE__*/function () {
  ...
  _createClass(ValidateCPF, [{
    key: "isSequencial",
    value: function isSequencial() {
      return this.clearedCPF.charAt(0).repeat(11) === this.clearedCPF;
    }
  }, {
    key: "generateNewCPF",
    value: function generateNewCPF() {
      var cpfWithoutDigit = this.clearedCPF.slice(0, -2);
      var firstDigit = ValidateCPF.generateDigit(cpfWithoutDigit);
      var secondDigit = ValidateCPF.generateDigit(cpfWithoutDigit + firstDigit);
    ...
    key: "generateDigit",
    value: function generateDigit(cpfWithoutDigit) {
      var total = 0;
      var reverse = cpfWithoutDigit.length + 1;

      var _iterator = _createForOfIteratorHelper(cpfWithoutDigit),
          _step;

      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var stringCPF = _step.value;
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "/* Criando variaveis para utilização - cores */\n:root {\n\n  --primary-color: #2A2C37;\n  --secondary-color: #24202E;\n  --font-color: #90F9FC;\n}\n\n* {\n\n  box-sizing: border-box;\n  outline: 0;  \n}\n\nbody {\n\n  background-color: var(--primary-color);\n  color: var(--font-color);\n  font-family: 'Montserrat', sans-serif;\n  font-size: 1.0em;\n  line-height: 1.3em;\n  letter-spacing: 1.5px;\n  margin: 0;\n  padding: 0;\n}\n\nh1 {\n  font-family: 'Abril Fatface', cursive;  \n  letter-spacing: 2px;\n  color: #957FFD;\n}\n\np {\n  text-align: justify;\n}\n\n.container {\n\n  max-width: 640px;\n  margin: 20px auto;\n  background: var(--secondary-color);\n  padding: 20px;\n  border-radius: 5px;\n}\n\nform input, form label, form button {\n\n  display: block;\n  width: 100%;\n  margin-bottom: 10px;\n}\n\nform input {\n\n  font-size: 20px;\n  font-weight: bold;\n  height: 30px;\n  padding: 0 20px;\n  background-color: var(--primary-color);\n  color: #72EC7C;  \n}\n\nform input:focus {\n\n  outline: 2px solid #72EC7C;\n}\n\nbutton {\n\n  border: none;\n  background-color: var(--font-color);\n  color: var(--secondary-color);\n  font-size: 18px;\n  font-weight: bold;\n  height: 30px;\n  cursor: pointer;\n  margin-top: 15px;\n  border-radius: 5px;\n}\n\nform button:hover {\n  background: #957FFD;\n  transition: background-color .3s;\n}\n\n.container h1 {\n  text-align: center;\n  margin-bottom: 40px;\n}\n\n.cpf-gerado {\n  font-size: 2em;\n  font-weight: 700;\n  color: #72EC7C;\n  text-align: center;\n  margin-bottom: 40px;\n}\n\n.btn-div {\n  width: 100%;  \n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n\n.bt:hover {\n  background-color: #957FFD;\n}", "",{"version":3,"sources":["webpack://./src/assets/css/style.css"],"names":[],"mappings":"AAGA,8CAA8C;AAC9C;;EAEE,wBAAwB;EACxB,0BAA0B;EAC1B,qBAAqB;AACvB;;AAEA;;EAEE,sBAAsB;EACtB,UAAU;AACZ;;AAEA;;EAEE,sCAAsC;EACtC,wBAAwB;EACxB,qCAAqC;EACrC,gBAAgB;EAChB,kBAAkB;EAClB,qBAAqB;EACrB,SAAS;EACT,UAAU;AACZ;;AAEA;EACE,qCAAqC;EACrC,mBAAmB;EACnB,cAAc;AAChB;;AAEA;EACE,mBAAmB;AACrB;;AAEA;;EAEE,gBAAgB;EAChB,iBAAiB;EACjB,kCAAkC;EAClC,aAAa;EACb,kBAAkB;AACpB;;AAEA;;EAEE,cAAc;EACd,WAAW;EACX,mBAAmB;AACrB;;AAEA;;EAEE,eAAe;EACf,iBAAiB;EACjB,YAAY;EACZ,eAAe;EACf,sCAAsC;EACtC,cAAc;AAChB;;AAEA;;EAEE,0BAA0B;AAC5B;;AAEA;;EAEE,YAAY;EACZ,mCAAmC;EACnC,6BAA6B;EAC7B,eAAe;EACf,iBAAiB;EACjB,YAAY;EACZ,eAAe;EACf,gBAAgB;EAChB,kBAAkB;AACpB;;AAEA;EACE,mBAAmB;EACnB,gCAAgC;AAClC;;AAEA;EACE,kBAAkB;EAClB,mBAAmB;AACrB;;AAEA;EACE,cAAc;EACd,gBAAgB;EAChB,cAAc;EACd,kBAAkB;EAClB,mBAAmB;AACrB;;AAEA;EACE,WAAW;EACX,aAAa;EACb,mBAAmB;EACnB,uBAAuB;AACzB;;AAEA;EACE,yBAAyB;AAC3B","sourcesContent":["@import url('https://fonts.googleapis.com/css2?family=Montserrat:wght@300&display=swap');\n@import url('https://fonts.googleapis.com/css2?family=Abril+Fatface&display=swap');\n\n/* Criando variaveis para utilização - cores */\n:root {\n\n  --primary-color: #2A2C37;\n  --secondary-color: #24202E;\n  --font-color: #90F9FC;\n}\n\n* {\n\n  box-sizing: border-box;\n  outline: 0;  \n}\n\nbody {\n\n  background-color: var(--primary-color);\n  color: var(--font-color);\n  font-family: 'Montserrat', sans-serif;\n  font-size: 1.0em;\n  line-height: 1.3em;\n  letter-spacing: 1.5px;\n  margin: 0;\n  padding: 0;\n}\n\nh1 {\n  font-family: 'Abril Fatface', cursive;  \n  letter-spacing: 2px;\n  color: #957FFD;\n}\n\np {\n  text-align: justify;\n}\n\n.container {\n\n  max-width: 640px;\n  margin: 20px auto;\n  background: var(--secondary-color);\n  padding: 20px;\n  border-radius: 5px;\n}\n\nform input, form label, form button {\n\n  display: block;\n  width: 100%;\n  margin-bottom: 10px;\n}\n\nform input {\n\n  font-size: 20px;\n  font-weight: bold;\n  height: 30px;\n  padding: 0 20px;\n  background-color: var(--primary-color);\n  color: #72EC7C;  \n}\n\nform input:focus {\n\n  outline: 2px solid #72EC7C;\n}\n\nbutton {\n\n  border: none;\n  background-color: var(--font-color);\n  color: var(--secondary-color);\n  font-size: 18px;\n  font-weight: bold;\n  height: 30px;\n  cursor: pointer;\n  margin-top: 15px;\n  border-radius: 5px;\n}\n\nform button:hover {\n  background: #957FFD;\n  transition: background-color .3s;\n}\n\n.container h1 {\n  text-align: center;\n  margin-bottom: 40px;\n}\n\n.cpf-gerado {\n  font-size: 2em;\n  font-weight: 700;\n  color: #72EC7C;\n  text-align: center;\n  margin-bottom: 40px;\n}\n\n.btn-div {\n  width: 100%;  \n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n\n.bt:hover {\n  background-color: #957FFD;\n}"],"sourceRoot":""}]);
// Exports
